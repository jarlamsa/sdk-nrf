...
#if defined(CONFIG_LWM2M_CLIENT_UTILS_LOCATION_ASSIST_AGPS) || defined(CONFIG_LWM2M_CLIENT_UTILS_LOCATION_ASSIST_PGPS)
...
static void gnss_event_handler(int event_id)
{
	...
	case NRF_MODEM_GNSS_EVT_AGPS_REQ: {
#if defined(CONFIG_LWM2M_CLIENT_UTILS_LOCATION_ASSIST_AGPS) || defined(CONFIG_LWM2M_CLIENT_UTILS_LOCATION_ASSIST_PGPS)
		LOG_INF("GPS requests AGPS Data");
		...
		APP_EVENT_SUBMIT(event);
#elif defined(CONFIG_LWM2M_CLIENT_UTILS_LOCATION_ASSIST_PGPS)
		//
#else
